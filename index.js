        ...
        fetch('https://api.kawalcorona.com/indonesia/')
                ...
                .then(json => {
                    ...
                    const covid = new Discord.MessageEmbed()
                        .setTitle("Informasi COVID negara "+data["name"])
                        .setImage("https://tc-health.com/wp-content/uploads/2020/03/corona-virus2-003.png")
                        .addField('Positif',data["positif"], true)
                        .addField('Sembuh',data["sembuh"], true)
                        .addField('Meninggal',data["meninggal"], true)
                        .addField('Dirawat',data["dirawat"], true)
                        .setColor(Math.floor(Math.random()*16777215).toString(16))
                        .setTimestamp();
